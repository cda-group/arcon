...
fn tumbling(
    ...
    quote! {
        pub type Assigner =
            EventTimeWindowAssigner<#input_type, #builder_type, #output_type, ChannelPort<#output_type>>;

        let channel_strategy: Box<Forward<#output_type, ChannelPort<#output_type>, Assigner>> =
