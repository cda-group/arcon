...
class ClusterListener extends Actor with ActorLogging {
  ...
  //private val coordinator = context.actorOf(Coordinator(), Identifiers.COORDINATOR)
  private val operatorHandler = context.actorOf(OperatorHandler(), "operator_handler")
