...
class ExtensionSpec extends TestKit(ExtensionSpec.actorSystem)
  ...
  "KompactExtension" must {
    ...
    "Register kompact, perform ask request and handle DeathWatch" in {
      ...
      // We should receive an KompactUp msg when a client connects
      expectMsgType[KompactUp]
      ...
      expectMsgType[KompactTerminated]
    }
  }
